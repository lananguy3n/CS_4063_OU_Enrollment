  ...
  return (
    <div className='max-w-xl rounded-2xl overflow-hidden shadow-lg bg-white p-2 m-2'>
        <div className='px-1 py-1'>
            <div className=' flex flex-row font-semibold text-xl mb-2'>
              {title}
              {addSemester && <Link to="/plan" className='bg-gray-400 text-white px-2 py-1 ml-auto h-6 text-sm flex justify-center items-center rounded-md'><button >{semesterval}</button></Link>}
