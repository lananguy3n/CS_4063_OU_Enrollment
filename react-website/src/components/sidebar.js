    ...
    return (
        <div className=" items-center justify-center w-64 h-screen bg-primary flex flex-col">
            ...
            <ul className=" text-white w-10/12 justify-center">
                <li className="font-medium px-4 py-3 hover:bg-tertiary cursor-pointer h-12" >Home</li>
                <li className="font-medium px-4 py-3 hover:bg-tertiary cursor-pointer h-12 ">Registration Status</li>
                <li className="font-medium px-4 py-3 hover:bg-tertiary cursor-pointer h-12 ">Plan & Register</li>
                <li className="font-medium px-4 py-3 hover:bg-tertiary cursor-pointer h-12 ">ClassNav</li>
                <li className="font-medium px-4 py-3 hover:bg-tertiary cursor-pointer h-12">My Schedules</li>
            </ul>
